...
static unsigned int blinktimeout = 777;
static unsigned int cursorthickness = 1; /* underline and bar cursors */
static unsigned int doubleclicktimeout = 300;
static unsigned int tripleclicktimeout = 600;
int allowwindowops = 0;
int allowaltscreen = 0;
static int bellvolume = 100; /* value -100 to 100, 0 = disabling */
